...
func (c *TariffRepoImpl) Init() {
	c.tariffs = []*entities.Tariff{
		...
		{Price: -1, Creds: entities.IDWithName{Name: "Enterprise", Id: TariffIDEnterprise}, Due: entities.YearDuration, FeatureAbilities: &entities.FeatureAbilities{MaxSequences: 999, MaxEmailsPerDay: 10000000, B2B: true, MaxB2BSearches: 10000000}},
	}
